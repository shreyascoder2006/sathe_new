...
export const ROLES: Record<Role, RoleConfig> = {
  ...
  maintenance: {
    ...
    initials: "RP",
    landing: "/labs",
    nav: ["/", "/command", "/labs", "/energy", "/accessibility", "/automation", "/incidents"],
    canOperate: true,
    canSimulate: false,
    accent: "#8b5cf6",
  },
  security: {
    ...
    initials: "SC",
    landing: "/security",
    nav: ["/", "/command", "/security", "/flow", "/accessibility", "/incidents"],
    canOperate: true,
    canSimulate: false,
    accent: "#f87171",
  },
  teacher: {
    ...
    initials: "PJ",
    landing: "/companion",
    nav: ["/", "/companion", "/command", "/flow", "/queues", "/lost-found"],
    canOperate: false,
    canSimulate: false,
    accent: "#2dd4bf",
  },
